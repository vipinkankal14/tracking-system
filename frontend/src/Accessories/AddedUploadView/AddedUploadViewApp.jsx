...
function AccessorieApp() {
  ...
  const [statusCards] = useState([
      ...
      {
        id: 'Updeta-accessories',
        title: 'Updeta Accessories',  
        icon: DirectionsCar,
        status: 'Uploade Excel Sheet for Accessories',
        iconType: 'secondary',
    ...
    
    {
        ...
        status: 'add accessories for manual',
      ...
      },
      {
        id: 'customer-accessories',
          title: 'Accessories View',  
        icon: DirectionsCar,
        status: 'List of Accessories',
        iconType: 'secondary',
        path: '/accessorie-view',
      },
  ]);
