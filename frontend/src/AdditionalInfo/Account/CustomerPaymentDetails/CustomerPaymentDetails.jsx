    ...
    if (sortConfig.key) {
      result.sort((a, b) => {
        ...
        if (sortConfig.key === "fullName") {
          aValue = `${a.firstName || ""} ${a.middleName || ""} ${
            a.lastName || ""
          }`.trim();
          bValue = `${b.firstName || ""} ${b.middleName || ""} ${
            b.lastName || ""
          }`.trim();
        } else if (sortConfig.key === "unpaidAmount") {
          aValue =
            Number.parseFloat(a.grand_total || 0) -
            Number.parseFloat(a.customer_account_balance || 0);
          bValue =
            Number.parseFloat(b.grand_total || 0) -
            Number.parseFloat(b.customer_account_balance || 0);
        } else {
                      ...
                      <Card.Body>
                        ...
                        <div className="mb-3">
                          ...
                          <Typography variant="body2">
                            <strong>Car:</strong> {customer.model} |{" "}
                            {customer.version} | {customer.color}
                          </Typography>
                        </div>
                        ...
                        <div className="d-flex justify-content-between mb-2">
                          ...
                          <Typography variant="body2">
                            {formatCurrency(customer.grand_total)}
                          </Typography>
                        </div>
                        ...
                        <div className="d-flex justify-content-end mt-3">
                          <IconButton
                            color="primary"
                            onClick={() =>
                              handleViewCustomerDetails(customer.customerId)
                            }
                          >
                            {customer.payment_status === "Paid" ? (
                    ...
                    {filteredCustomers.length > 0 ? (
                      filteredCustomers.map((customer) => (
                        <TableRow key={customer.customerId} hover>
                          ...
                          <TableCell style={{ fontSize: "11px" }}>
                            {customer.model} | {customer.version} |{" "}
                            {customer.color}
                          </TableCell>
                          <TableCell style={{ fontSize: "11px" }}>
                            {formatCurrency(customer.grand_total)}
                          ...
                          <TableCell>
                            ...
                            >
                              <AssessmentIcon
                                style={{ color: "#9c39e3", fontSize: "18px" }}
                              />
                            </IconButton>
                          </TableCell>
                        </TableRow>
