          ...
          <Box sx={{ mt: 2 }}>
            ...
            <Typography variant="body2" sx={{ mt: 1 }}>
              ...
              {customer.RTORequests[0]?.createdAt
                ? new Date(customer.RTORequests[0].createdAt).toLocaleString()
                : "N/A"}
            </Typography>
            <Typography variant="body2" sx={{ mt: 1 }}>
              <strong>Updated At:</strong>{" "}
              {customer.RTORequests[0]?.updatedAt
                ? new Date(customer.RTORequests[0].updatedAt).toLocaleString()
                : "N/A"}
            </Typography>
            <Typography variant="body2" sx={{ mt: 1, color: "error.main" }}>
              <strong>Rejection Reason:</strong>{" "}
              {customer.RTORequests[0]?.rtoReason || "N/A"}
            </Typography>
...
const RTOApproved = () => {
  ...
  // Filter customers based on search query (only Approval)
  ...
  return (
    <div style={{ padding: "20px" }}>
      <Typography variant="h5" sx={{ mb: 3, color: "#071947" }}>
        RTO Management - Approval Requests
      </Typography>
