    ...
    if (expandedRow) {
      ...
      if (selectedCustomer) {
        const {
          additional_info,
          loans,
          orders_accessories_request,
          car_fasttag_requests,
          car_insurance_requests,
          car_extended_warranty_requests,
          car_autocard_requests,
        ...
        if (
          additional_info.accessories === "Yes" &&
          orders_accessories_request
        ) {
          statusData.push({
            id: "accessories",
  ...
  return (
    <Box sx={{ p: { xs: 1, sm: 2, md: 3 } }}>
      ...
      >
        ...
        >
          <Typography variant="h6">Security Clearance Approved</Typography>
          <IconButton
            edge="end"
            color="inherit"
            onClick={handleClose}
