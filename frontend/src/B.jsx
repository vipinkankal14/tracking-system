  ...
  return (
    <div className="desktop-only-margin-AdditionalInfo">
      <Grid container spacing={4} style={{ marginTop: "-1rem" }}>
        ...
        <Grid item xs={12} sm={6} md={3}>
          <FormControl component="fieldset" size="small" fullWidth>
            <FormLabel component="legend">Insurance</FormLabel>
            <RadioGroup
              name="insurance"
        ...
        <Grid item xs={12} sm={6} md={3}>
          <FormControl component="fieldset" size="small" fullWidth>
            <FormLabel component="legend">Extended Warranty</FormLabel>
            <RadioGroup
              name="extendedWarranty"
              value={data.extendedWarranty}
              onChange={handleChange}
              row
            >
              <FormControlLabel
        ...
        <Grid item xs={12} sm={6} md={3}>
          <FormControl component="fieldset" size="small" fullWidth>
            <FormLabel component="legend">Auto Card</FormLabel>
            <RadioGroup
              name="autoCard"
              value={data.autoCard}
              onChange={handleChange}
