  ...
  const getIntensityStyle = () => {
    switch (intensity) {
      ...
      case "high":
        return {
          "--neon-text-shadow":
            "0 0 7px rgba(240, 171, 252, 1), 0 0 10px rgba(240, 171, 252, 0.8), 0 0 21px rgba(240, 171, 252, 0.6), 0 0 42px rgba(240, 171, 252, 0.4)",
        }
      case "medium":
      default:
        return {
          "--neon-text-shadow":
            "0 0 7px rgba(240, 171, 252, 0.8), 0 0 10px rgba(240, 171, 252, 0.5), 0 0 21px rgba(240, 171, 252, 0.3)",
        }
    }
  }
