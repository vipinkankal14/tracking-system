...
const coatingOptions = [
    ...
    },
    {
        ...
        pros: ["More durable than ceramic", "Better heat resistance", "Highly hydrophobic", "Reduces swirl marks"],
    ...
    },
    {
        ...
        pros: ["Affordable", "Protects against minor scratches", "Smooth glossy finish", "Water-repellent"],
        cons: ["Short lifespan"],
        budget: 2,
        amount: "5400.00 Rs",
    },
    {
        ...
        pros: ["Best protection against scratches", "Self-healing", "UV protection", "Gloss/matte options"],
    ...
    },
    {
        ...
        cons: ["Requires frequent reapplication", "Less durable than other coatings"],
        budget: 1,
        amount: "7000.00 Rs",
    },
    {
        ...
        pros: ["Extremely hydrophobic", "Deep glass-like shine", "UV & chemical resistant"],
...
export function CoatingModal({ open, onClose, personalInfo, carInfo }) {
    ...
    useEffect(() => {
        const selectedCoating = coatingOptions.find(option => option.value === formData.coatingType);
        if (selectedCoating) {
            ...
            <Modal open={open} sx={{ display: "flex", alignItems: "flex-end", justifyContent: "flex-end" }}>
                <Box component={Paper} sx={{ width: { xs: "100%", sm: "60vh" }, height: { xs: "100%", sm: "99%" }, marginBottom: { sm: "4px" } }}>
                    <Stack spacing={1} sx={{ p: 1, maxWidth: 600, height: { xs: "100%", sm: "100%" }, overflowY: "auto", borderRadius: 2 }}>
                            ...
                            <Stack spacing={4}>
                                ...
                                <Box>
                                    ...
                                    <Stack spacing={3}>
                                        ...
                                        {selectedCoating && (
                                            <Box>
                                                <Typography variant="subtitle1">Protection: {selectedCoating.protection}</Typography>
                                                <Typography variant="subtitle1">Durability: {selectedCoating.durability}</Typography>
                                                ...
                                                <Typography variant="subtitle1">Amount: {selectedCoating.amount}</Typography>
                                            </Box>
                                        )}
                        ...
                        <Box sx={{  p: 1,display: "flex", justifyContent: "space-between", alignItems: "end" }}>
