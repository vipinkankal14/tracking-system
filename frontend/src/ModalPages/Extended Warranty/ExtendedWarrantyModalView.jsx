...
const ExtendedWarrantyModalView = ({
    open,
    onClose,
    personalInfo,
    carInfo,
    onShowExtendedWarranty,
}) => {
                ...
                >
                    ...
                    >
                        <Box textAlign="center" sx={{ p: 2 }}>
                            <Typography variant="h5">Car ExtendedWarranty Services</Typography>
                        </Box>
...
export default ExtendedWarrantyModalView;
