...
export function RTOdModal({ open, onClose, personalInfo }) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!personalInfo?.customerId) {
      alert(
        "Please fill in your personal information before submitting the Car RTOd Services."
      );
      return;
    }
    ...
    try {
      ...
      console.error("Error submitting RTOd request:", error);
      alert("An error occurred while submitting the RTOd request.");
    }
  };
  ...
  return (
    <>
      ...
      <Dialog open={confirmationOpen}>
        ...
        <DialogContent>
          <DialogContentText>
            Your RTOd form has been submitted successfully.
          </DialogContentText>
        </DialogContent>
        <DialogActions>
